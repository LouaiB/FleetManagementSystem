...
namespace FleetApi1.Migrations
{
    ...
    [Migration("20190429010925_deliverySummary1")]
    partial class deliverySummary1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FleetApi1.Models.Activity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FleetApi1.Models.Bill", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FleetApi1.Models.Delivery", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FleetApi1.Models.DeliverySummary", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FleetApi1.Models.Manager", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FleetApi1.Models.MapLocation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FleetApi1.Models.Plan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FleetApi1.Models.Route", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FleetApi1.Models.ScheduledActivity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FleetApi1.Models.Vehicle", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FleetApi1.Models.Activity", b =>
                {
                    b.HasOne("FleetApi1.Models.Plan", "Plan")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("FleetApi1.Models.Bill", b =>
                {
                    b.HasOne("FleetApi1.Models.Vehicle", "Vehicle")
                        .WithMany("Bills")
            ...
            modelBuilder.Entity("FleetApi1.Models.Company", b =>
                {
                    b.HasOne("FleetApi1.Models.Manager", "Manager")
                        .WithMany()
            ...
            modelBuilder.Entity("FleetApi1.Models.Delivery", b =>
                {
                    ...
                    b.HasOne("FleetApi1.Models.Driver", "Driver")
                        .WithMany("Deliveries")
            ...
            modelBuilder.Entity("FleetApi1.Models.DeliverySummary", b =>
                {
                    b.HasOne("FleetApi1.Models.Delivery", "Delivery")
                        .WithMany()
            ...
            modelBuilder.Entity("FleetApi1.Models.MapLocation", b =>
                {
                    b.HasOne("FleetApi1.Models.Route", "Route")
                        .WithMany("Points")
            ...
            modelBuilder.Entity("FleetApi1.Models.ScheduledActivity", b =>
                {
                    b.HasOne("FleetApi1.Models.Activity", "Activity")
            ...
            modelBuilder.Entity("FleetApi1.Models.Vehicle", b =>
                {
                    ...
                    b.HasOne("FleetApi1.Models.Driver", "CurrentDriver")
                        .WithMany()
                        .HasForeignKey("CurrentDriverId");

                    b.HasOne("FleetApi1.Models.Manager")
                        .WithMany("Vehicles")
                        .HasForeignKey("ManagerId");
